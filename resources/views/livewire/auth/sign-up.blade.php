    ...
    <div class="w-1/4 mx-auto overflow-hidden bg-white rounded-lg shadow-md min-w-96 dark:bg-gray-800">
        <div class="px-6 py-4">
            ...
            <form>
                ...
                <div class="w-full mt-4">
                    <input class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="password" placeholder="Password Confirmation" aria-label="Password Confirmation" />
                </div>
    
                <div class="mt-4 text-center">
                    <livewire:partials.primary-link-button :url="'#'" :content="'Create Account'" />
                </div>
            </form>
        </div>
