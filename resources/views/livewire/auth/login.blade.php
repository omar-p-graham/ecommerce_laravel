    ...
    <div class="px-6 py-4">
        ...
        <form wire:submit.prevent="loginUser">
            ...
            <div class="flex items-center justify-between mt-4">
                <a href="/forgot-password" wire:navigate class="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-500">Forgot Password?</a>
                <div class="">
                    <livewire:partials.primary-button :content="'Sign In'" />
                </div>
            </div>
        </form>
    </div>
