            ...
            <table class="min-w-full text-center divide-y divide-mid">
              <thead>
                <tr class="bg-mid dark:bg-darkest">
                  <th scope="col" class="px-6 py-3 text-xs font-medium uppercase rounded-l-md">Order</th>
                  ...
                  <th scope="col" class="px-6 py-3 text-xs font-medium uppercase rounded-r-md">Action</th>
                </tr>
              </thead>
              <tbody>
                @forelse ($orders as $order)
                  ...
                  <tr class="odd:bg-lightest even:bg-light dark:odd:bg-dark dark:even:bg-darkest" wire:key="{{$order->id}}">
                    ...
                    <td class="px-6 py-4 text-sm capitalize whitespace-nowrap"><span class="px-3 py-1 {{$statusClass}} rounded shadow">{{$order->status}}</span></td>
                    <td class="px-6 py-4 text-sm capitalize whitespace-nowrap"><span class="px-3 py-1 {{$paymentClass}} rounded shadow">{{$order->payment_status}}</span></td>
                ...
                @empty
                  <tr>
                    <td colspan="6" class="text-xl font-bold text-center">You Have Not Made Any Orders</td>
                  </tr>
                @endforelse
              </tbody>
            </table>
