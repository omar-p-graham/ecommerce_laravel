                  ...
                  <tr class="transition-all duration-500 bg-transparent hover:bg-light dark:hover:bg-mid dark:hover:text-darkest group/tr">
                      ...
                      <td class="p-5 text-sm font-medium leading-6 whitespace-nowrap">
                        <div class="flex items-center">
                          ...
                          <button class="flex p-2 mx-auto transition-all duration-500 border rounded-full border-mid hover:bg-mid dark:hover:bg-dark item-center dark:hover:text-lightest dark:group-hover/tr:border-dark" wire:click="increaseItemQuantity({{$item['product_id']}})">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
          ...
          <div class="p-6 rounded-lg shadow-md bg-lightest dark:bg-dark">
            ...
            @if ($items)
              <div class="w-full py-3 mt-5">
                <x-primary-link-button href="/checkout" class="block w-full text-center">Checkout</x-primary-link-button>
              </div>
            @endif
          </div>
        </div>
