                  ...
                  <div class="[&>ul]:list-disc">
                    ...
                    <div class="my-10">
                      <div class="w-full mb-4 md:w-60">
                        <div class="px-3 py-2 font-bold border rounded-lg border-dark bg-mid dark:bg-dark">
                          <div class="flex items-center justify-between w-full gap-x-5">
                            <div class="grow">
                              <span class="block text-xs">Select quantity</span>
                              <input class="w-full p-0 bg-transparent border-0 focus:ring-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:text-white" style="-moz-appearance: textfield;" type="number" aria-roledescription="Number field" value="{{$productquantity}}" readonly>
                            </div>
                      ...
                      <div class="w-full md:w-60">
                        <x-primary-button class="w-full" wire:click="addToCart({{$product->id}},{{$productquantity}})">Add to Cart</x-primary-button>
                      </div>
                    </div>
                  </div>
                </div>
